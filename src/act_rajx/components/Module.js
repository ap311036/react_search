...
export default class Module extends Component {
    ...
    _itemOnClickHandler (item, e) {
        this.setState({ select: item.dataIndex });
        this.props.getItemClickValue(item, e);
    }
    whenKeyPress (e) {
        if (this.props.isFocus) {
            if (e.keyCode === 40) {
                ...
                this._itemOnClickHandler(this.newData[index], e);
            }
            if (e.keyCode === 38) {
                ...
                this._itemOnClickHandler(this.newData[prevIndex], e);
            }
        }
    }
                                                    ...
                                                    return (
                                                        <span
                                                            className={cx('item', this.props.itemClass, {
                                                              select: (this.props.selectedVal ? this.props.selectedVal.dataIndex : this.state.select) === items.dataIndex
                                                            })}
                                                            key={items.level3}
